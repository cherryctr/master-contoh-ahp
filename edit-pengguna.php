...
if (!empty($_GET)) {
    ...
    if ($data) {
        ...
        $level = $data['level'];
        $nama = $data['nama'];
    } else header('Location: ./manajemen-pengguna.php');
} else header('Location: ./manajemen-pengguna.php');
...
<form method="post" class="mx-auto" style="max-width:400px" autocomplete="off">
    ...
    <button class="btn btn-danger" type="reset" onclick="location.href='./manajemen-pengguna.php'"><span class="fas fa-times"></span> Batal</button>
