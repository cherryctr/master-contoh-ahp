...
<body onload="window.print()">
	...
	<center>
        ...
        <h5>Nama Supplier&nbsp;&nbsp; : <?= $res[5] ?></h5>
        <h5>Alamat&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; : <?= $res[6] ?></h5>
        <h5>No.Telp &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;  : <?= $res[7] ?></h5>
        <h5>No.Fax &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;: <?= $res[8] ?></h5>
        <h5>Alamat Email&nbsp; &nbsp; &nbsp; : <?= $res[9] ?></h5>
        <h5>Nilai &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; : <?= number_format($res[1], 4, '.', ',') ?></h5>

        <br>
        <h5> Pada tanggal <?= date("d M Y", strtotime($periode)) ?> terpilih sebagai Supplier <b>TERBAIK</b> pada PT Talkindo Selaksa Anugrah.</h5>
        <br>
        <br>
